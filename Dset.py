...
if shutil.which("kwriteconfig6") and shutil.which("plasma_session"):
    ...
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group AC --group HandleButtonEvents --key lidAction 64', shell=True, check=False)
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group AC --group HandleButtonEvents --key powerButtonAction 8', shell=True, check=False)
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group AC --group HandleButtonEvents --key powerDownAction 16', shell=True, check=False)
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group AC --group HandleButtonEvents --key triggerLidActionWhenExternalMonitorPresent false', shell=True, check=False)
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group AC --group DimDisplay --key idleTime --delete', shell=True, check=False)
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group Battery --group HandleButtonEvents --key lidAction 1', shell=True, check=False)
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group Battery --group HandleButtonEvents --key powerButtonAction 1', shell=True, check=False)
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group Battery --group HandleButtonEvents --key powerDownAction 16', shell=True, check=False)
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group Battery --group HandleButtonEvents --key triggerLidActionWhenExternalMonitorPresent false', shell=True, check=False)
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group Battery --group DimDisplay --key idleTime --delete', shell=True, check=False)
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group AC --group DPMSControl --key idleTime 300', shell=True, check=False)
    if vmstatus or args.disable_powersave:
        subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group AC --group DPMSControl --key idleTime 300000', shell=True, check=False)
    else:
        subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group AC --group DPMSControl --key idleTime 600', shell=True, check=False)
    # Disable AC suspend
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group AC --group SuspendSession --key idleTime --delete', shell=True, check=False)
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group AC --group SuspendSession --key suspendThenHibernate --delete', shell=True, check=False)
    subprocess.run('kwriteconfig6 --file powermanagementprofilesrc --group AC --group SuspendSession --key suspendType --delete', shell=True, check=False)
            ...
            for entry in it:
                ...
                if "default" in entry.name and os.path.isdir(firefox_profilefolder):
                    ...
                    if os.path.isfile(prefsjs_file):
                        ...
                        firefox_modify_settings("browser.newtabpage.activity-stream.showSponsoredTopSites", "false", prefsjs_file)
                        ...
                        firefox_modify_settings("app.normandy.enabled", "false", prefsjs_file)
                        # Firefox view
                        firefox_modify_settings("browser.tabs.firefox-view", "false", prefsjs_file)
                        # DNS-over-HTTPS
