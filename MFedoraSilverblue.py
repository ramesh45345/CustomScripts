...
if args.stage == 1:
    ...
    ### OSTree Apps ###
    # Cli tools
    rostreeinstall("fish zsh tmux iotop p7zip util-linux-user fuse-sshfs redhat-lsb-core powerline-fonts google-noto-sans-fonts samba hdparm cups-pdf tilix tilix-nautilus syncthing numix-icon-theme numix-icon-theme-circle tigervnc xrandr xset")
    ...
    if fedora_version.endswith("silverblue"):
        # Extra packages
        rostreeinstall("google-roboto-fonts smartmontools p7zip-plugins")
...
if args.stage == 2:
    ...
    # Media apps
    rostreeinstall("ffmpeg mpv smplayer")
